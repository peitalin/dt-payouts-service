...
pub struct PaypalPaidoutBatchResponse {
    pub batch_header: PaypalPaidoutBatchHeader,
    pub items: Vec<PaypalPaidoutItem>,
    pub links: Option<Vec<PaypalLink>>,
}

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct PaypalPaidoutBatchHeader {
    ...
    pub time_created: Option<chrono::NaiveDateTime>,
    #[serde(deserialize_with = "from_datetimestr_to_option_naivedatetime")]
    pub time_completed: Option<chrono::NaiveDateTime>,
    pub amount: Option<PaypalValue>,
    pub fees: Option<PaypalValue>,
}

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct PaypalPaidoutItem {
    pub payout_item_id: String,
    pub transaction_id: String,
    pub transaction_status: String,
    pub payout_batch_id: String,
    pub payout_item_fee: PaypalValue,
    pub payout_item: PaypalPayout,
    #[serde(deserialize_with = "from_datetimestr_to_option_naivedatetime")]
    pub time_processed: Option<chrono::NaiveDateTime>,
}

#[test]
fn deserializes_paypal_get_payout_details() {
    ...
    let res = serde_json::from_str::<PaypalPaidoutBatchResponse>(test_str);
    match res {
        Ok(batch_response) => {
            assert_eq!(
                batch_response.batch_header.payout_batch_id,
                String::from("FYXMPQTX4JC9N")
            );
            assert_eq!(
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct PaypalPaidoutItemDetails {
    pub payout_item_id: String,
...
#[test]
fn deserializes_paypal_get_payout_item_details() {
